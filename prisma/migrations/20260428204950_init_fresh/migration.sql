...
CREATE TABLE "tutors" (
    ...
    "yearsExperience" DECIMAL(10,2) DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_tutorId_fkey" FOREIGN KEY ("tutorId") REFERENCES "tutors"("id") ON DELETE CASCADE ON UPDATE CASCADE;
